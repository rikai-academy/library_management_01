...
<div id="content"><br>
    <div class="products">
        ...
        <script async defer crossorigin="anonymous"
            ...
            <div class="fb-share-button" data-href="{{$og_fb['url_page']}}" data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{$og_fb['url_page']}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
